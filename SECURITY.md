...
The following versions of `lbenicio.github.io` are currently supported with security updates:
...
- Preferred: Open a private report via GitHub Security Advisories — [Create a private advisory](https://github.com/lbenicio/lbenicio.github.io/security/advisories/new)
